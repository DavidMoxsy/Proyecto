...
<html lang="en">
    ...
    <head>
        ...
        <link href="../css/css_Administradores/styleAdministradores.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
        <div class="container-form sign-up">
            ...
            <form id="formulario" class="formulario" onsubmit="crearAdministrador('http://localhost:8080/Proyecto_2_Version_Final/resources/restfulAdministradores', event)">
        ...
        <div class="container-form sign-in">
            <form id="iniciar" class="formulario" onsubmit="solicitarDatos3('http://localhost:8080/Proyecto_2_Version_Final/resources/restfulAdministradores/getPorID', buscarDatoPorId, iniciarSesion, event)">
