...
<html lang="en">
    ...
    <body>
        <div class="container-form sign-up">
            ...
            <form id="formulario" class="formulario" onsubmit="crearPaciente('http://localhost:8080/Proyecto_2_Version_Final/resources/restfulPacientes', event)">
        ...
        <div class="container-form sign-in">
            <form id="iniciar" class="formulario" onsubmit="solicitarDatos3('http://localhost:8080/Proyecto_2_Version_Final/resources/restfulPacientes/getPorID', buscarDatoPorId, iniciarSesion, event)">
