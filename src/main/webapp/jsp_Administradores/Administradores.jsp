...
<html lang="en">
    ...
    <body>
        <div class="container-form sign-up">
            ...
            <form id="formulario" class="formulario" onsubmit="crearAdministrador('http://localhost:8080/Proyecto/resources/restfulAdministradores', event)">
        ...
        <div class="container-form sign-in">
            <form id="iniciar" class="formulario" onsubmit="solicitarDatos3('http://localhost:8080/Proyecto/resources/restfulAdministradores/getPorID', buscarDatoPorId, iniciarSesion, event)">
