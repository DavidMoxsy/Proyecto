...
<html>
    ...
    <head>
        ...
        <link href="../css/css_Pacientes/Pantalla_Principal_Paciente.css" rel="stylesheet" type="text/css"/>
    ...
    <body onload="solicitarDatos2('http://localhost:8080/Proyecto_2_Version_Final/resources/restfulPacientes/getPorID', buscarDatoPorId, pacienteIniciado)">
        ...
        <nav class="menu">
            <ul>
                <li><a href="Pantalla_Principal_Pacientes.jsp?cedula=<%=id%>">Inicio</a></li>
                <li><a href="Paciente_Iniciado.jsp?cedula=<%=id%>">Perfil</a></li>
                <li><a href="Citas_Paciente.jsp?cedula=<%=id%>">Citas</a></li>
            </ul>           
        </nav>
        ...
        <div class="volver">
            <button class="btn_Volver" onclick="enviarBoton('salir_Perfil_Paciente')">Salir</button>
        </div>
